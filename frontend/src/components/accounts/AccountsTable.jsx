    ...
    if (activeTab === 'invoices') {
      return [
        ...
        },
        {
          ...
          header: 'Status',
          render: (val) => (
            <span className={`text-xs px-2.5 py-1 rounded-full font-medium flex items-center gap-1 w-fit ${val === 'Received' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' :
