    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-2">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">View your assigned schedule and weekly offs.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-gray-800">Current Assigned Shift</span>
            </div>
          ...
          <div className="p-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h3 className="text-3xl font-black text-gray-800">{shift.name}</h3>
                <p className="text-gray-400 font-medium text-sm mt-1">Full-time Regular Schedule</p>
              </div>
              <div className="text-right">
                <p className="text-sm font-bold text-gray-400 uppercase tracking-widest">Off Day</p>
                <p className="text-lg font-bold text-gray-700">{shift.weeklyOff}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-2xl font-black text-gray-800">{shift.startTime}</p>
              </div>
              ...
              <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-2xl font-black text-gray-800">{shift.endTime}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="font-bold text-gray-800 mb-2">Weekly Off</h3>
          <p className="text-gray-500 text-sm mb-6">
            You have a fixed weekly off every <span className="font-bold text-gray-800">{shift.weeklyOff}</span>.
          </p>
